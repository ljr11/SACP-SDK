import { readInt16, readUint32, readUint8, writeUint8 } from '../../helper';
import { Serializable } from '../../Serializable';

class DryBoxStatus implements Serializable {
    dryState: number = 1;
    ...
    fromBuffer(buffer: Buffer) {
        ...
        this.currentHumidity = readInt16(buffer, 7);
        this.targetHumidity = readInt16(buffer, 9);
